...
The Go and TypeScript resource client templates add an exact external-reference lookup method when the OpenAPI collection declares that query parameter. `executeTemplate` is locally adjusted
