...
The checks scan Git-tracked files for forbidden terminology and mutable
external dependencies. GitHub Actions and Git dependencies require full commit
...
only with `imagePullPolicy: Never` because they are never fetched from a
registry.
