...
| `platform/openshell-gateway-database.spec.md` | platform | Gateway, ManagedCluster, PostgreSQL ownership | API, CP, CLI, SDK, WEB, hypbox | openshell-gateway, managed-cluster-registration |
