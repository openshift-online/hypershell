...
| `platform/openshell-gateway-keycloak.spec.md` | platform | Keycloak OIDC client provisioning, gateway ownership, visibility | API | openshell-gateway, openshell-gateway-oidc |
