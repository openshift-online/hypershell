...
| `platform/openshell-gateway-keycloak.spec.md` | platform | Keycloak OIDC client provisioning, RBAC OIDC role bridge | CP | openshell-gateway, openshell-gateway-oidc, rbac-enforcement |
