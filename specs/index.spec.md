...
| `platform/source-release.spec.md` | platform | Release PR, source release, build identity | API, CP, WEB, CI | cross-cutting, local-development, e2e-testing, web-console/architecture |
