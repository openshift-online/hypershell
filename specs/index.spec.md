...
| `platform/generic-agent-base.spec.md` | platform | Generic Agent base, sandbox-consuming CronJob agents, agent-lib.sh, kustomize base, amber-review overlay | GITOPS | openshell-inference-routing, openshell-gateway-service-accounts, global-architecture, security |
