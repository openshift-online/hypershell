...
// checks if the OpenShellGatewayServiceAccountListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenShellGatewayServiceAccountListItem{}

// OpenShellGatewayServiceAccountListItem struct for OpenShellGatewayServiceAccountListItem
...
type _OpenShellGatewayServiceAccountListItem OpenShellGatewayServiceAccountListItem
...
func NewOpenShellGatewayServiceAccountListItem(id string, gatewayId string, name string, credentialType string, role OpenShellGatewayServiceAccountRole, status OpenShellGatewayServiceAccountStatus, createdByUserId string, clientId string, subject string, expiresAt time.Time, createdAt time.Time, updatedAt time.Time) *OpenShellGatewayServiceAccountListItem {
	this := OpenShellGatewayServiceAccountListItem{}
	this.Id = id
...
func (o *OpenShellGatewayServiceAccountListItem) SetDescriptionNil() {
...
func (o *OpenShellGatewayServiceAccountListItem) SetRevokedAtNil() {
	o.RevokedAt.Set(nil)
}
...
func (o *OpenShellGatewayServiceAccountListItem) SetLastErrorNil() {
	o.LastError.Set(nil)
}
...
func (o OpenShellGatewayServiceAccountListItem) MarshalJSON() ([]byte, error) {
...
func (o OpenShellGatewayServiceAccountListItem) ToMap() (map[string]interface{}, error) {
...
func (o *OpenShellGatewayServiceAccountListItem) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenShellGatewayServiceAccountListItem := _OpenShellGatewayServiceAccountListItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpenShellGatewayServiceAccountListItem)

	if err != nil {
		return err
	}

	*o = OpenShellGatewayServiceAccountListItem(varOpenShellGatewayServiceAccountListItem)

	return err
}

type NullableOpenShellGatewayServiceAccountListItem struct {
	value *OpenShellGatewayServiceAccountListItem
	isSet bool
}

func (v NullableOpenShellGatewayServiceAccountListItem) Get() *OpenShellGatewayServiceAccountListItem {
	return v.value
}

func (v *NullableOpenShellGatewayServiceAccountListItem) Set(val *OpenShellGatewayServiceAccountListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenShellGatewayServiceAccountListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenShellGatewayServiceAccountListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenShellGatewayServiceAccountListItem(val *OpenShellGatewayServiceAccountListItem) *NullableOpenShellGatewayServiceAccountListItem {
	return &NullableOpenShellGatewayServiceAccountListItem{value: val, isSet: true}
}

func (v NullableOpenShellGatewayServiceAccountListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenShellGatewayServiceAccountListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
