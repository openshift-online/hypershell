...
type ApiGetUserActivityStatsRequest struct {
	ctx        context.Context
	ApiService *DefaultAPIService
}

func (r ApiGetUserActivityStatsRequest) Execute() (*UserActivityStats, *http.Response, error) {
	return r.ApiService.GetUserActivityStatsExecute(r)
}

/*
GetUserActivityStats Get registered user activity statistics

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetUserActivityStatsRequest
*/
func (a *DefaultAPIService) GetUserActivityStats(ctx context.Context) ApiGetUserActivityStatsRequest {
	return ApiGetUserActivityStatsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) GetUserActivityStatsExecute(r ApiGetUserActivityStatsRequest) (*UserActivityStats, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UserActivityStats
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetUserActivityStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/hypershell/v1/users/stats"
