...
`func (o *Role) GetPermissions() map[string]interface{}`

GetPermissions returns the Permissions field if non-nil, zero value otherwise.

### GetPermissionsOk

`func (o *Role) GetPermissionsOk() (*map[string]interface{}, bool)`
...
`func (o *Role) SetPermissions(v map[string]interface{})`
