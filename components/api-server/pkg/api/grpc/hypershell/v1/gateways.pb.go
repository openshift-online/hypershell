...
type UpdateGatewayRequest struct {
	...
	ActiveSandboxCount *int32                 `protobuf:"varint,20,opt,name=active_sandbox_count,json=activeSandboxCount,proto3,oneof" json:"active_sandbox_count,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *UpdateGatewayRequest) GetActiveSandboxCount() int32 {
	if x != nil && x.ActiveSandboxCount != nil {
		return *x.ActiveSandboxCount
	}
	return 0
...
const file_hypershell_v1_gateways_proto_rawDesc = "" +
	...
	"\agateway\x18\x01 \x01(\v2\x16.hypershell.v1.GatewayR\agateway\"\xee\a\n" +
	...
	"\x11credential_driver\x18\x13 \x01(\tH\x10R\x10credentialDriver\x88\x01\x01\x125\n" +
	"\x14active_sandbox_count\x18\x14 \x01(\x05H\x11R\x12activeSandboxCount\x88\x01\x01B\a\n" +
	"\x05_nameB\v\n" +
	"\t_fleet_idB\r\n" +
	"\v_cluster_idB\r\n" +
	"\v_release_idB\x0e\n" +
