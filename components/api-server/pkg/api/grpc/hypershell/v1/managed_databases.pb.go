...
type ManagedDatabase struct {
	...
	// The NAMESPACE holding the admin credentials Secret, not a Secret name.
	// Bare namespace name (no "/"), prefixed with "hypershell-managed-db-", a
	// valid DNS-1123 label. The Secret inside it is always named
...
const file_hypershell_v1_managed_databases_proto_rawDesc = "" +
	"\n" +
	"%hypershell/v1/managed_databases.proto\x12\rhypershell.v1\x1a\x1ahypershell/v1/common.proto\"\xd0\x03\n" +
	...
	"\a_statusJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\v\x10\fR\bfleet_idR\bproviderR\tnamespace\"\x90\x03\n" +
	...
	"\x0f_instance_classB\x14\n" +
	"\x12_connection_secretB\t\n" +
	"\a_statusJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04R\bfleet_idR\bprovider\"j\n" +
	...
	"\x10managed_database\x18\x01 \x01(\v2\x1e.hypershell.v1.ManagedDatabaseR\x0fmanagedDatabase\"\xae\x03\n" +
	"\x1cUpdateManagedDatabaseRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\x04name\x18\x02 \x01(\tH\x00R\x04name\x88\x01\x01\x12\x1b\n" +
	"\x06region\x18\x05 \x01(\tH\x01R\x06region\x88\x01\x01\x12\x1b\n" +
	"\x06engine\x18\x06 \x01(\tH\x02R\x06engine\x88\x01\x01\x12*\n" +
	"\x0eengine_version\x18\a \x01(\tH\x03R\rengineVersion\x88\x01\x01\x12*\n" +
	"\x0einstance_class\x18\b \x01(\tH\x04R\rinstanceClass\x88\x01\x01\x120\n" +
	"\x11connection_secret\x18\t \x01(\tH\x05R\x10connectionSecret\x88\x01\x01\x12\x1b\n" +
	"\x06status\x18\n" +
	" \x01(\tH\x06R\x06status\x88\x01\x01B\a\n" +
	"\x05_nameB\t\n" +
	"\a_regionB\t\n" +
	"\a_engineB\x11\n" +
	"\x0f_engine_versionB\x11\n" +
	"\x0f_instance_classB\x14\n" +
	"\x12_connection_secretB\t\n" +
	"\a_statusJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05R\bfleet_idR\bprovider\"j\n" +
