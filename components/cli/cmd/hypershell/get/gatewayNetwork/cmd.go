...
var Cmd = &cobra.Command{
	Use:     "gatewayNetwork ID",
	Aliases: []string{"gatewayNetworks"},
	Short:   "Get a gatewayNetwork by ID",
	Long:    "Get a gatewayNetwork by ID and display its details",
...
func run(cmd *cobra.Command, argv []string) error {
	...
	resp, err := conn.Get(urls.GatewayNetworkPath(id), nil)
	if err != nil {
		return fmt.Errorf("can't retrieve gatewayNetwork: %v", err)
	}
