...
var Cmd = &cobra.Command{
	...
	Short:   "Get a fleet by ID",
	Long:    "Get a fleet by ID and display its details",
...
func run(cmd *cobra.Command, argv []string) error {
	...
	resp, err := conn.Get(urls.FleetPath(id), nil)
	if err != nil {
		return fmt.Errorf("can't retrieve fleet: %v", err)
	}
