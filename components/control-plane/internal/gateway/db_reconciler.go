...
// Delete removes out-of-namespace database resources; it is best-effort - failures
...
func (r *noopDatabaseReconciler) Delete(_ context.Context, _ dynamic.Interface, _ kubernetes.Interface, _ string) {
}
